...
wave_model_1(x) = sin(10π*x)
wave_model_2(x) = cos(10π*x)
...
set_param_y_ticks(0.0075)

visualize(q_chain; type=:graph, save="C:/Users/Porpun/OneDrive/Desktop/QubitChain/visuals/test_realistic.jpg")